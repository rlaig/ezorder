      ...
      <div className="p-6">
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Welcome to the EZOrder Admin Portal. Manage merchants and monitor platform activity.
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg border border-gray-200">
          <div className="px-6 py-4 border-b border-gray-200">
            <h2 className="text-lg font-semibold text-gray-900">Recent Merchant Activity</h2>
          </div>
          <div className="p-6">
            <div className="text-center py-8 text-gray-500">
              <p>Recent activity will be displayed here once merchants start using the platform.</p>
            </div>
          </div>
        </div>
      </div>
