import { Home, Building2, BarChart3, Settings, PanelLeft, User2 } from 'lucide-react';
...
export function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const navigation: SideNavigationItem[] = [
    ...
    { name: 'Merchants', to: paths.admin.merchants.getHref(), icon: Building2 },
    { name: 'Analytics', to: paths.admin.analytics.getHref(), icon: BarChart3 },
    { name: 'Settings', to: paths.admin.settings.getHref(), icon: Settings },
  ];
